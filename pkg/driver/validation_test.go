...
func TestValidateMode(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			mode:   Mode("unknown"),
			expErr: fmt.Errorf("Mode is not supported (actual: unknown, supported: %v)", supportedModes),
		},
	}
...
func TestValidateDriverOptions(t *testing.T) {
	testCases := []struct {
		...
		},
		{
			...
			mode:   Mode("unknown"),
			expErr: fmt.Errorf("invalid mode: Mode is not supported (actual: unknown, supported: %v)", supportedModes),
		},
	}
