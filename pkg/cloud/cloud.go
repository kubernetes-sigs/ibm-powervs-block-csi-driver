...
type Cloud interface {
	...
	GetPVMInstanceByID(instanceName string) (instance *PVMInstance, err error)
	GetImageByID(id string) (image *PVMImage, err error)
}
...
//}
//
//func (c *cloud) GetPVMInstanceByName(name string) (instanceID string, err error) {
//	panic("implement me")
//}
//
//var _ Cloud = &cloud{}
